...
Alternative, clone this repository and follow its readme:

```shell
git clone https://github.com/owkin/flower-fedeca.git && cd flower-fedeca
```
...
From this directory, first install the dependencies:
...
With the new `[superlink.remote]` added, you can run the app:
